# dir(): The dir() function returns a list of all 
# the attributes and methods (including dunder methods) 
...
# help(): The help() function is used to get help 
# documentation for an object, including a description 
