...
# shutil.copy("main.py", "main2.py") # It works for files only
# shutil.copytree(".tutorial", "mytutorial") # Used for directories
# shutil.move(".tutorial/file.file", "file.file") # Used for directories
