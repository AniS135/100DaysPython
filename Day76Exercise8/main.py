...
# files into a single pdf. You are welcome to add more functionalities

# pypdf is a free and open-source pure-python PDF 
# library capable of splitting, merging, cropping, 
# and transforming the pages of PDF files. It can also 
# add custom data, viewing options, and passwords to PDF 
